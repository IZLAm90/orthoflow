...
export interface DeliveryCenter { id:string; name:string; address?:string|null; phone?:string|null }
export type DeliveryCenterCreate = { name:string; address?:string; phone?:string }
